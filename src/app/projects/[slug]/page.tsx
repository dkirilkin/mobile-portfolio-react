...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fcf8ff_0%,#f7f4fb_100%)] px-4 py-6 text-[#281f36] sm:px-6 sm:py-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 lg:grid lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-[2rem] border border-[#dbcff1] bg-white p-5 shadow-[0_24px_60px_rgba(106,75,153,0.10)]">
