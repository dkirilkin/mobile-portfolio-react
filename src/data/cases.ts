...
export const cases: Case[] = [
  {
    ...
    isVisible: true,
    slug: "ev-charging",
    title: "Выездная зарядка электромобилей",
    contribution: "Я разработал приложения для клиентов и техников на Flutter + Supabase. Диспетчерская и OCPP-брокер показаны как части общей системы.",
...
- OCPP-брокер подключается на этапе зарядки, управляет станцией и ведет статистику сессии
  ...
  },
  {
    ...
    isVisible: true,
    slug: "goods-delivery",
    title: "Доставка еды: заказать — собрать — доставить",
